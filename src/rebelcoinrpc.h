...
#ifndef _rebelcoinRPC_H_
#define _rebelcoinRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // rebelcoin is not connected
...
/**
 * rebelcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
