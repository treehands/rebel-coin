...
// for both rebelcoind and rebelcoin-qt, to make it harder for attackers to
// target servers or GUI users specifically.
const std::string CLIENT_NAME("rebelcoin");

// Client version number
#define CLIENT_VERSION_SUFFIX   "-REB"
...
#        define BUILD_DATE "November 1, 2013"
#    else
